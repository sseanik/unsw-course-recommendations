...
* **👨‍💻 COMP2521** - Data Structures & Algorithms
	...
	* **Difficulty**: 🟠 Medium - Hard. It can be Hard if you don't put time into it. If you do 3 subjects a term including 2521, you may struggle, it's a course where you really want to spend as much time as you can on it for the course and your overall CS knowledge.
...
* **👨‍🏫 COMP2511** - Object Oriented Programming
	...
	* **Lecturer**: Ashesh
	* **Difficulty**: 🟡 Medium. Difficulty depends if you have a good project partner.
...
* **🧱 COMP3900** - Computer Science Project
	...
	* **Difficulty**: 🟢 Easy - Hard. Completely depends on getting a good group. I advertised on their WebCMS forums detailing my coding and work experience and I recruited the best of my class.
...
## COMP/Free Electives
* **⌨️ COMP2041** - Software Construction **(STRONGLY RECOMMEND)**
...
* **🎨 COMP3511** - Human Computer Interaction
	...
	* **Lecturer**: Sasha
	* **Difficulty**: 🟢 Easy. Can be harder if you get a garbage group, or you struggle thinking in a more artist centric way.
...
* **🖧 COMP3331** - Computer Networks
	...
	* **Difficulty**: 🟠 Hard. The mid term had negative marking (i.e. multiple choice, if you get it wrong, -1 mark). Final exam, all theory. Some multiple choice, some short answer and some calculational short answers.
...
* **🎭 COMP6841** - Extended Security Engineering
	...
	* **Difficulty**: 🟡 Medium. It's time consuming, content is easy to grasp though.
...
* **🤖 COMP6771** - Advanced C++ **(STRONGLY RECOMMEND)**
	...
	* **Lecturer**: Hayden
	* **Difficulty**: 🟠 Hard. It can be difficult to grasp, and I am rating it a hard due to never completely 100%ing assignments, but I don't think it's a grind your teeth hard. It's easy to understand, but applying it, you are expected to code things correctly, not near-correctly.
...
* **🖼️ COMP6080** - Frontend **(STRONGLY RECOMMEND)**
	...
	* **Lecturer**: Hayden
	* **Difficulty**: 🟡 Medium - Assignments took time and exam was a hard one to finish on time. Just time is the issue, everything is easy enough to grasp.
